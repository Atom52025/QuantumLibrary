  ...
  return (
    <>
      <button className="group w-full h-full relative" onClick={() => onOpen()}>
        ...
        <div className="absolute bottom-0 w-full text-center font-bold uppercase text-sm lg:text-xl bg-gray-900/40 p-1 opacity-0 group-hover:opacity-100">{entry.game.name}</div>
